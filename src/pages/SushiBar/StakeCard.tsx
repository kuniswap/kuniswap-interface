...
interface StakeCardProps {
    kuniBalance: BalanceProps
    xKUKUBalance: BalanceProps
}

export default function StakeCard({ kuniBalance, xKUKUBalance }: StakeCardProps) {
    ...
    */
    ...
    const balance: BalanceProps = activeTab === 0 ? kuniBalance : xKUKUBalance
    ...
    const insufficientFunds = (activeTab === 0 ? kuniBalance : xKUKUBalance).value.lt(parsedInput.value)
